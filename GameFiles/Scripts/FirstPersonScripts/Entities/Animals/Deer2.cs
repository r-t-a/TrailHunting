...
public class Deer2 : AnimalEntity
{
    [Signal]
    ...
    public override void Init()
    {
        HP = 1;
        Speed = 70;
        Connect(nameof(MediumGameDead), Tree.GetNode("FirstPersonStart"), "_on_Deer_MediumGameDead");
    }

    private void _on_Deer_input_event(Node viewport, InputEvent inputEvent, int shape_idx)
    {
